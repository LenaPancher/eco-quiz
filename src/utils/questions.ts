...
export const QUESTIONS: Level[] = [
  {
    level: 1,
    questions: [
      new QuestionItem("Quel déchet peut être recyclé ?", ["Plastique", "Pain", "Carton", "Le verre"], "Le verre"),
  ...
  },
  {
    level: 2,
    questions: [
      new QuestionItem("Quel type de transport est le plus écologique ?", ["Le vélo", "Voiture électrique", "Avion", "Moto"], "Le vélo"),
